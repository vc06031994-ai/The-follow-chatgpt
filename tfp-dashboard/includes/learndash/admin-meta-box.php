...
add_action('init', function () {
    ...
    $fields = [
        ...
        // Structured facilitator notes list (JSON array of {author_id, text, created_at})
        'tfp_week_meeting_facilitator_notes_list' => function ($value) {
            if (empty($value)) {
                return '';
            }
            if (is_string($value)) {
...
add_action('enqueue_block_editor_assets', function () {
    ...
    // Provide the current user id to the editor panel script so it can
    // attribute facilitator notes to the logged-in editor when created.
    wp_localize_script('tfp-week-meta-panel', 'tfpWeekEditorSettings', [
